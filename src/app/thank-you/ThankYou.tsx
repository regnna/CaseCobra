        ...
        return (
            <div className="w-full mt-24 flex justify-center">
                <div className="flex flex-col items-center gap-2">
                    <Loader2 className="j-8 w-8 animate-spin text-zinc-500"/>
                    <h3 className="font-semibold text-xl">Loading your order...</h3>
                    <p>It wont take long</p>
                </div>
        ...
        <div className="mt-10 border-t border-zinc-200">
            <div className="mt-10 flex flex-auto flex-col">
                ...
                <p className="mt-2 text-sm text-zinc-600">
                    WE at CaseCobra bekieve that a phone case doesn't only need to look good, but also last you for years to come. We offer a 5- year print guarantee: If your case isn't highest quality.
